...
g <- ggplot()+geom_line(aes(x=as.factor(output_k),y=output_trial,group=1))+theme(axis.text.x = element_text(angle=45))
...
gg<- ggplot()+geom_line(aes(x=as.factor(ks),y=apply(df,2,mean)),group=1)+theme(axis.text.x = element_text(angle=45))
